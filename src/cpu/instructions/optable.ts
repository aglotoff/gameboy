...
import { prefixCB } from "./prefixed-optable";
...
const instructions: OpTable = [
  ...
  /* 0x02 */ loadPointerInBCFromAccumulator,
  ...
  /* 0x0a */ loadAccumulatorFromPointerInBC,
  ...
  /* 0x12 */ loadPointerInDEFromAccumulator,
  ...
  /* 0x1a */ loadAccumulatorFromPointerInDE,
  ...
  /* 0x20 */ bia(jumpToRelativeConditionally, Condition.NZ),
  /* 0x21 */ bia(loadRegisterPair, RegisterPair.HL),
  /* 0x22 */ loadPointerInHLFromAccumulatorAndIncrement,
  ...
  /* 0x28 */ bia(jumpToRelativeConditionally, Condition.Z),
  /* 0x29 */ bia(addRegisterPair, RegisterPair.HL),
  /* 0x2a */ loadAccumulatorFromPointerInHLAndIncrement,
  ...
  /* 0x30 */ bia(jumpToRelativeConditionally, Condition.NC),
  /* 0x31 */ bia(loadRegisterPair, RegisterPair.SP),
  /* 0x32 */ loadPointerInHLFromAccumulatorAndDecrement,
  /* 0x33 */ bia(incrementRegisterPair, RegisterPair.SP),
  /* 0x34 */ incrementPointerInHL,
  /* 0x35 */ decrementPointerInHL,
  /* 0x36 */ loadPointerInHLFromImmediateData,
  /* 0x37 */ setCarryFlag,
  /* 0x38 */ bia(jumpToRelativeConditionally, Condition.C),
  /* 0x39 */ bia(addRegisterPair, RegisterPair.SP),
  /* 0x3a */ loadAccumulatorFromPointerInHLAndDecrement,
  ...
  /* 0x46 */ bia(loadRegisterFromPointerInHL, Register.B),
  ...
  /* 0x4e */ bia(loadRegisterFromPointerInHL, Register.C),
  ...
  /* 0x56 */ bia(loadRegisterFromPointerInHL, Register.D),
  ...
  /* 0x5e */ bia(loadRegisterFromPointerInHL, Register.E),
  ...
  /* 0x66 */ bia(loadRegisterFromPointerInHL, Register.H),
  ...
  /* 0x6e */ bia(loadRegisterFromPointerInHL, Register.L),
  /* 0x6f */ bia(loadRegisterFromRegister, Register.L, Register.A),

  /* 0x70 */ bia(loadPointerInHLFromRegister, Register.B),
  /* 0x71 */ bia(loadPointerInHLFromRegister, Register.C),
  /* 0x72 */ bia(loadPointerInHLFromRegister, Register.D),
  /* 0x73 */ bia(loadPointerInHLFromRegister, Register.E),
  /* 0x74 */ bia(loadPointerInHLFromRegister, Register.H),
  /* 0x75 */ bia(loadPointerInHLFromRegister, Register.L),
  /* 0x76 */ halt,
  /* 0x77 */ bia(loadPointerInHLFromRegister, Register.A),
  ...
  /* 0x7e */ bia(loadRegisterFromPointerInHL, Register.A),
  ...
  /* 0x86 */ addPointerInHLToAccumulator,
  ...
  /* 0x8e */ addPointerInHLToAccumulatorWithCarry,
  ...
  /* 0x96 */ subtractPointerInHLFromAccumualtor,
  ...
  /* 0x9e */ subtractPointerInHLFromAccumualtorWithCarry,
  ...
  /* 0xa6 */ andAccumulatorWithPointerInHL,
  ...
  /* 0xae */ xorAccumulatorWithPointerInHL,
  ...
  /* 0xb6 */ orAccumulatorWithPointerInHL,
  ...
  /* 0xbe */ compareAccumulatorToPointerInHL,
  /* 0xbf */ bia(compareAccumulatorToRegister, Register.A),

  /* 0xc0 */ bia(returnFromFunctionConditionally, Condition.NZ),
  /* 0xc1 */ bia(popFromStack, RegisterPair.BC),
  /* 0xc2 */ bia(jumpToAddressConditionally, Condition.NZ),
  /* 0xc3 */ jumpToAddress,
  /* 0xc4 */ bia(callFunctionConditionally, Condition.NZ),
  /* 0xc5 */ bia(pushToStack, RegisterPair.BC),
  /* 0xc6 */ addImmediateToAccumulator,
  /* 0xc7 */ bia(restartFunction, 0x00),
  /* 0xc8 */ bia(returnFromFunctionConditionally, Condition.Z),
  /* 0xc9 */ returnFromFunction,
  /* 0xca */ bia(jumpToAddressConditionally, Condition.Z),
  /* 0xcb */ prefixCB,
  /* 0xcc */ bia(callFunctionConditionally, Condition.Z),
  /* 0xcd */ callFunction,
  /* 0xce */ addImmediateToAccumulatorWithCarry,
  /* 0xcf */ bia(restartFunction, 0x08),

  /* 0xd0 */ bia(returnFromFunctionConditionally, Condition.NC),
  /* 0xd1 */ bia(popFromStack, RegisterPair.DE),
  /* 0xd2 */ bia(jumpToAddressConditionally, Condition.NC),
  /* 0xd3 */ bia(invalidOpcode, 0xd3),
  /* 0xd4 */ bia(callFunctionConditionally, Condition.NC),
  /* 0xd5 */ bia(pushToStack, RegisterPair.DE),
  /* 0xd6 */ subtractImmediateFromAccumualtor,
  /* 0xd7 */ bia(restartFunction, 0x10),
  /* 0xd8 */ bia(returnFromFunctionConditionally, Condition.C),
  /* 0xd9 */ returnFromInterruptHandler,
  /* 0xda */ bia(jumpToAddressConditionally, Condition.C),
  /* 0xdb */ bia(invalidOpcode, 0xdb),
  /* 0xdc */ bia(callFunctionConditionally, Condition.C),
  ...
  /* 0xe2 */ loadPointerInCFromAccumulator,
  ...
  /* 0xf2 */ loadAccumulatorFromPointerInC,
